...
#include <cstdlib>
/* 
6. Напишите проограмму, которая нааходит множество фундаментальных циклов связного неориентированного графа.
...
После хавершения работы с динамическими структурами данных необходимо освободить занимаемую ими память.
*/
...
//#define m 10 // количество столбцов в хеш-таблице

class Adjacency_list //хеш-таблица
{
	private:

		static int IDS; // индивидуальный
		int m_id;       // индификатор хеш-таблицы
...
class Graph //хеш-таблица
{
	...
	public:
		...
		void Input(char *name)
		{
		    ...
		    fclose(f); // тк файл открывается то для чтения то для записи
